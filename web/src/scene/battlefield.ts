...
/**
 * 大厅高墙之外的一切：被踩烂的战争平原、两座围城军营、火葬堆、
 * 栅栏、损毁的攻城器械、远处列阵的长枪兵，以及硝烟窒息的黄昏地平线。
 *
 * 开销通过设置 `InstancedMesh.count` / 绘制范围来调节，而不是靠重建，
 * 所以切换画质预设绝不会卡帧。
 */

/** 确定性 PRNG，让战场每次加载的布局完全一致。 */
...
export class Battlefield {
  ...
  /**
   * 两道嶙峋的山脉剪影。雾被禁用，霾改为烘焙进顶点颜色，
   * 这样山脊在被雾笼罩的平原后面依然清晰可读。
   */
  ...
  /**
   * 按竞技场主题重绘高墙之外的世界：天空渐变、山间霾色、地面色调、
   * 营火燃烧的猛烈程度，以及灰烬与烟雾在新天空下的可见度。
   */
  ...
  /**
   * 低画质预设保留地形、军营剪影和天空，但去掉那些增加绘制调用却
   * 收益甚微的散落的道具、军旗和飞鸟；此外，有些地图根本不布置
   * 攻城器械。
   */
