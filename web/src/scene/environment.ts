...
/**
 * 棋盘所在的火把石厅：石板地面、带拱门的柱环、
 * 高窗透入体积感光柱、飘浮的尘埃、余烬粒子，
 * 以及一盏暖色主光映照下的四支摇曳火把。
 */
export class CastleHall {
  ...
  private buildColonnade(): void {
    ...
    // 幕墙：一段完好的墙体承载着高窗，其余部分
    // 被轰塌成齐腰高的残桩，让外面的战火透进来。
    ...
    /** 以 `centre` 为中心的幕墙弧段（与柱子使用相同的角度空间）。 */
  ...
  /**
   * 按竞技场主题重新点亮大厅：灯光、石材色调、玻璃、光柱
   * 和火把强度。白昼主题下火把仍然燃烧，但强度大幅压低，
   * 使其看起来是装饰而非唯一光源。
   */
...
/**
 * 由程序化渐变穹顶加上暖色自发光面板构建的 PMREM 环境，
 * 让盔甲与抛光大理石反射出大厅而非一片虚空。
 */
