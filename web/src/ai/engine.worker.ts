...
/**
 * 国际象棋引擎 Worker。
 * Negamax + alpha-beta 剪枝、MVV-LVA 着法排序、杀手着法、吃子静态搜索，
 * 以及在墙钟时间预算内的迭代加深。
 * 跑在主线程之外，渲染循环永远不会被卡住。
 */
...
/** 静态局面评估，单位厘兵（centipawn），正值 = 对白方有利。 */
